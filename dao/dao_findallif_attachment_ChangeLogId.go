...
func DB_FindallifAttachmentbyChangeLogId (ChangeLogId string, page, size, searchTerm string, noPagination bool) (int64, *[]dto.Attachment, error) {
    var skip int64 = 0
    var limit int64 = 0
    ...
    filter := bson.M{"changelogid" :ChangeLogId, "deleted" : false}
