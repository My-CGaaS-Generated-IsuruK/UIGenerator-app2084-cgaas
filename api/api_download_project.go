...
// @Summary      DownloadProject 
// @Description   This API performs the DOWNLOAD operation on Project. It allows you to  Project records.
// @Tags          Project
// @Accept       json
// @Produce      json
...
// @Router      /DownloadProject [DOWNLOAD]

    func DownloadProjectApi(c *fiber.Ctx) error {


    _, objects, err := dao.DB_FindallProject ("1", "10", "", true)
	if err != nil {
		return err
	}
	...
	fileName := "Projects" + time.Now().Format("2006-01-02") + ".csv"
