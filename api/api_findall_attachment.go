...
// @Router      /FindallAttachment [GET]

    func FindallAttachmentApi(c *fiber.Ctx) error {
  ...
  Count, Attachment ,err := dao.DB_FindallAttachment(page,size,searchTerm,noPagination)
    if err != nil {
