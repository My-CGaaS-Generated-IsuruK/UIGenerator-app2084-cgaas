...
// @Summary      DownloadChangeLog 
// @Description   This API performs the DOWNLOAD operation on ChangeLog. It allows you to  ChangeLog records.
// @Tags          ChangeLog
// @Accept       json
// @Produce      json
...
// @Router      /DownloadChangeLog [DOWNLOAD]

    func DownloadChangeLogApi(c *fiber.Ctx) error {


    _, objects, err := dao.DB_FindallChangeLog ("1", "10", "", true)
	if err != nil {
		return err
	}
	...
	fileName := "ChangeLogs" + time.Now().Format("2006-01-02") + ".csv"
