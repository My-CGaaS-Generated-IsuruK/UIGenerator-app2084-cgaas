...
// @Description   This API performs the DOWNLOAD operation on Attachment. It allows you to  Attachment records.
// @Tags          Attachment
// @Accept       json
// @Produce      json
...
// @Router      /DownloadAttachment [DOWNLOAD]

    func DownloadAttachmentApi(c *fiber.Ctx) error {


    _, objects, err := dao.DB_FindallAttachment ("1", "10", "", true)
	if err != nil {
		return err
	}
	...
	fileName := "Attachments" + time.Now().Format("2006-01-02") + ".csv"
