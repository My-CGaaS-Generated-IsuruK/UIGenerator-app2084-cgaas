...
// @Router      /FindallConfig [GET]

    func FindallConfigApi(c *fiber.Ctx) error {
  ...
  Count, Config ,err := dao.DB_FindallConfig(page,size,searchTerm,noPagination)
    if err != nil {
