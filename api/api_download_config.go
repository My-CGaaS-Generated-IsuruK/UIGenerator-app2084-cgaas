...
// @Description   This API performs the DOWNLOAD operation on Config. It allows you to  Config records.
// @Tags          Config
// @Accept       json
// @Produce      json
...
// @Router      /DownloadConfig [DOWNLOAD]

    func DownloadConfigApi(c *fiber.Ctx) error {


    _, objects, err := dao.DB_FindallConfig ("1", "10", "", true)
	if err != nil {
		return err
	}
	...
	fileName := "Configs" + time.Now().Format("2006-01-02") + ".csv"
